        ...
        >
            ...
            <View style={styles.button}>
                <TouchableOpacity onPress={() => navigation.navigate('EditProfile')} style={[styles.editProfileButton, {borderWidth: 1, borderColor: "#009387"}]}>
                    <Text style={[styles.textSign, {color: "#009387"}]}>Edit Profile</Text>
                </TouchableOpacity>
            </View>
        </ScrollView>
...
function EditProfile({navigation}){
    ...
    function handleProfileEdit(navigation) {
        ...
        axios.put(url, json, {
            ...
            .then((response) => {
                    Alert.alert("Success", "Profile Successfully Edited", [{text: "Okay"}])
                    navigation.goBack();
                }, (error) => {
                    console.log(error)
        ...
        <View style={theme.dark ? styles.darkContainer : styles.container}>
            ...
            >
                <KeyboardAwareScrollView>
                    <Text style={[styles.text_footer, { color: theme.dark ? "white" : "#05375a" },]}>
                        First Name
                    </Text>
                    ...
                    <Text style={[styles.text_footer, { color: theme.dark ? "white" : "#05375a", marginTop: 35 },]}>
                        Last Name
                    </Text>
                    <View style={styles.action}>
                        <FontAwesome
                    ...
                    <View style={styles.button}>
                        <TouchableOpacity onPress={() => {handleProfileEdit(navigation);}} style={[styles.signIn, {borderWidth: 1, borderColor: "#009387"}]}>
