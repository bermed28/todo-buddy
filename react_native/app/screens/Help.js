...
const faq = [
    {
        ...
        answer: "On the Tasks Page, press the \"Create New Task\" button. " +
    ...
    },
    {
        ...
        answer: "Yes! Head over to the Profile page, where you will see your profile information, " +
            "alongside a button to edit your profile information."
    },
    {
        id: "3",
        question: "How can I complete a task?",
        answer: "On the tasks page, press on the checkmark on the left-hand side of the task tom mark it as completed." +
...

    {
        ...
        answer: "To turn on dark mode, open the drawer navigator by swiping from left to right on the screen. " +
...

    {
        ...
        answer: "Yes, just swipe right on the current page or click on the \"Back\" button when available. Another option is to open the drawer navigator and tap ont he preferred page to navigate"
    },
]
